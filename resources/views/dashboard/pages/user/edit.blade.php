                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm @error('nis') is-invalid @enderror" id="nis"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kelas">
                                ...
                                @if (old('kelas', $user->kelas) === $kelas->id)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control form-control-sm @error('tgl_lahir') is-invalid @enderror"
                                id="tgl_lahir" name="tgl_lahir" value="{{ old('tgl_lahir', $user->tgl_lahir) }}">
                            @error('tgl_lahir')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control form-control-sm @error('alamat') is-invalid @enderror" id="alamat"
                                name="alamat" value="{{ old('alamat') }}">{{ old('alamat',$user->alamat) }}</textarea>
                            @error('alamat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-6">
                        {{-- <div class="mb-3">
                            ...
                            <select class="form-select" name="jenis_kelamin" value="{{ old($user->jenis_kelamin) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="role" value="{{ old($user->role) }}">
