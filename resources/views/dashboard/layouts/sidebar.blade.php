<aside class="sidebar">
    ...
    <a href="/dashboard" class="sidebar-item {{ $active === 'overview' ? 'active' : '' }}" onclick="toggleActive(this)">
    ...
    <a href="#" class="sidebar-item" onclick="toggleActive(this)">
        {{-- <img src="/img/global/settings.svg" alt=""> --}}
        ...
        {{-- <svg fill="#ABB3C4" width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
